        ...
        <div className="p-4">
          {!shareUrl ? (
            <>
              {/* Destinataire */}
              {recipientName && (
                <div className="bg-primary-50 dark:bg-primary-900/30 rounded-lg p-3 mb-4 flex items-center gap-3">
            ...
            <>
              ...
              {/* URL */}
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3 mb-4 flex items-center gap-2">
                <input
                  type="text"
                  value={shareUrl}
                  readOnly
