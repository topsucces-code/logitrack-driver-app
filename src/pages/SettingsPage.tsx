...
export default function SettingsPage() {
  ...
  const [maxDistance, setMaxDistance] = useState(
    driver?.max_distance_km || DRIVER_CONFIG.defaultMaxDistanceKm,
  );
  ...
  async function updateSettings(overrides?: {
    auto_accept?: boolean;
    ...
    <div className="h-mobile-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-y-auto p-3 pb-4 space-y-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg">
          ...
          <button
            ...
            className="w-full px-3 py-2 flex items-center justify-between border-b border-gray-100 dark:border-gray-700"
          >
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Lorsqu'une nouvelle livraison est disponible, une notification
                apparaît sur votre écran. Appuyez sur "Accepter" pour prendre en
                charge la livraison.
              </p>
            </div>
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Vos gains sont automatiquement crédités sur votre portefeuille.
                Vous pouvez les retirer via Mobile Money depuis la page
                Portefeuille.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-sm text-gray-900 dark:text-white mb-1">
                Comment modifier ma zone de livraison ?
              </h3>
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Contactez le support via le chat pour modifier vos zones de
                livraison. Un conseiller vous assistera rapidement.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-sm text-gray-900 dark:text-white mb-1">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Utilisez le bouton SOS disponible sur la page de livraison en
                cours, ou contactez le support via le chat en direct.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-sm text-gray-900 dark:text-white mb-1">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Allez dans Outils → Optimisation d'itinéraire pour réorganiser
                automatiquement vos livraisons et réduire vos temps de trajet.
              </p>
            </div>
          </div>
        </InfoModal>
        ...
        <InfoModal title={t.termsOfService} onClose={() => setShowTerms(false)}>
          <div className="space-y-3 text-xs text-gray-600 dark:text-gray-400">
            <p className="font-semibold text-sm text-gray-900 dark:text-white">
              Conditions Générales d'Utilisation — LogiTrack Africa
            </p>
            <p>
              <strong>1. Objet</strong>
              <br />
              Les présentes conditions régissent l'utilisation de l'application
              LogiTrack par les livreurs partenaires en Côte d'Ivoire.
            </p>
            <p>
              <strong>2. Inscription</strong>
              <br />
              L'inscription nécessite la fourniture d'informations exactes
              (identité, véhicule, coordonnées Mobile Money). Tout document
              frauduleux entraîne la suspension immédiate du compte.
            </p>
            <p>
              <strong>3. Obligations du livreur</strong>
              <br />
              Le livreur s'engage à : livrer les colis en bon état, respecter
              les délais, maintenir une communication courtoise avec les
              clients, et respecter le code de la route.
            </p>
            <p>
              <strong>4. Rémunération</strong>
              <br />
              La rémunération est calculée par livraison effectuée. Les
              paiements sont versés via Mobile Money. LogiTrack prélève une
              commission sur chaque livraison.
            </p>
            <p>
              <strong>5. Résiliation</strong>
              <br />
              LogiTrack se réserve le droit de suspendre ou résilier un compte
              en cas de non-respect des présentes conditions, de plaintes
              répétées ou de comportement inapproprié.
            </p>
            <p>
              <strong>6. Responsabilité</strong>
              <br />
              Le livreur est responsable des colis qui lui sont confiés. En cas
              de perte ou dommage par négligence, des retenues pourront être
              appliquées.
            </p>
          </div>
        </InfoModal>
          ...
          <div className="space-y-3">
                ...
                >
                  ...
                  <button
                    onClick={async () => {
                      ...
                      setNotifPrefs((prev) =>
                        prev ? { ...prev, [item.key]: newVal } : null,
                      );
                      if (driver)
                        await updatePreferences(driver.user_id!, {
                          [item.key]: newVal,
                        });
                    }}
                    className={`relative w-10 h-6 rounded-full transition-colors ${
            ...
            <div>
              ...
              {(
                [
                  {
                    key: "driver_assigned_enabled",
                    label: "Nouvelle course assignée",
                  },
              ...
              <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                ...
                <button
                  onClick={async () => {
                    ...
                    setNotifPrefs((prev) =>
                      prev ? { ...prev, quiet_hours_enabled: newVal } : null,
                    );
                    if (driver)
                      await updatePreferences(driver.user_id!, {
      ...
      {showPrivacy && (
        ...
        >
          <div className="space-y-3 text-xs text-gray-600 dark:text-gray-400">
            <p className="font-semibold text-sm text-gray-900 dark:text-white">
              Politique de Confidentialité — LogiTrack Africa
            </p>
            <p>
              <strong>1. Données collectées</strong>
              <br />
              Nous collectons : nom, téléphone, photo de profil, documents
              d'identité, position GPS (pendant les livraisons), données de
              véhicule et informations Mobile Money.
            </p>
            <p>
              <strong>2. Utilisation des données</strong>
              <br />
              Vos données servent à : gérer votre compte, attribuer les
              livraisons, calculer les itinéraires, traiter les paiements et
              améliorer nos services.
            </p>
            <p>
              <strong>3. Géolocalisation</strong>
              <br />
              La position GPS est utilisée uniquement pendant les livraisons
              actives pour le suivi en temps réel. Vous pouvez désactiver le
              suivi en passant hors ligne.
            </p>
            <p>
              <strong>4. Partage des données</strong>
              <br />
              Vos données ne sont jamais vendues. Le nom et la photo peuvent
              être partagés avec le client lors d'une livraison. Les données de
              paiement sont transmises à votre opérateur Mobile Money.
            </p>
            <p>
            ...
            <p>
              ...
              vos données en contactant le support.
            </p>
          </div>
        </InfoModal>
      )}
...
function InfoModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-t-2xl max-h-[85dvh] flex flex-col animate-slide-up safe-bottom">
