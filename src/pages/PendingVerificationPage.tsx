    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-primary-500 text-white safe-top px-3 pt-3 pb-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-base font-bold">Vérification du compte</h1>
          <button
        ...
        <div className="bg-white/10 backdrop-blur rounded-lg p-3">
          ...
          {driver.rejection_reason && (
            <div className="mt-2 p-2.5 bg-red-500/20 rounded-lg">
              <p className="text-xs text-white/90">{driver.rejection_reason}</p>
            </div>
          )}
        </div>
      </header>
      ...
      <div className="flex-1 px-3 -mt-3">
        ...
        <div className="bg-white rounded-lg shadow-sm divide-y divide-gray-100">
          <div className="p-3">
            <h2 className="font-semibold text-gray-900 text-sm mb-0.5">Statut de votre dossier</h2>
          ...
          <div className="px-3 py-2.5 flex items-center gap-2.5">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500">{driver.full_name}</p>
            </div>
          ...
          <div className="px-3 py-2.5 flex items-center gap-2.5">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500">CNI + Permis de conduire</p>
            </div>
          ...
          <div className="px-3 py-2.5 flex items-center gap-2.5">
            ...
            <div className="flex-1">
              <p className="font-medium text-gray-900 text-sm">Véhicule</p>
          ...
          <div className="px-3 py-2.5 flex items-center gap-2.5">
            ...
            <div className="flex-1">
              <p className="font-medium text-gray-900 text-sm">Zones de livraison</p>
              <p className="text-xs text-gray-500">
        ...
        <div className="mt-4 space-y-2">
          ...
          <button
            ...
            className="w-full py-2.5 bg-green-500 hover:bg-green-600 text-white font-medium text-sm rounded-lg flex items-center justify-center gap-2"
          >
          ...
          {(status.profile === 'rejected' || status.documents === 'rejected' || status.vehicle === 'rejected' || driver.verification_status === 'rejected') && (
            <button
              ...
              className="w-full py-2.5 bg-primary-500 hover:bg-primary-600 text-white font-medium text-sm rounded-lg flex items-center justify-center gap-2"
            >
          ...
          <button
            onClick={signOut}
            className="w-full py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-sm rounded-lg flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-4 mb-6">
          <h3 className="font-semibold text-gray-900 text-sm mb-2">Questions fréquentes</h3>
