...
export interface SOSAlert {
  ...
  latitude: number;
  longitude: number;
  alert_type: 'emergency' | 'accident' | 'security' | 'medical' | 'vehicle_issue';
...
export function callEmergencyServices() {
  // Police: 110, Pompiers: 180, SAMU: 185
  window.location.href = 'tel:110';
}

// Call support
export function callSupport() {
  window.location.href = 'tel:+2250700000000'; // LogiTrack support number
}
